...
export default async function Home() {
  ...
  // Check category exists before using _id
  if (categoryData?.length > 0 && categoryData[0]?._id) {
    productData = await homeFeaturedProduct(categoryData[0]._id);
  } else {
