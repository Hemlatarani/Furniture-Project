                    ...
                    <g transform="translate(13.75,9.25)" className="loader__model">
                        ...
                        <g strokeLinecap="round" stroke="hsl(35,90%,90%)">
                            ...
                            <line
                                ...
                                strokeWidth="1"
                                stroke="hsl(35,90%,83%)"
                                className="loader__sand-line-left"></line>
                            <line y2="31.5" x2="12.5" y1="16" x1="12.5" strokeDasharray="12 96"
                                stroke="hsl(35,90%,83%)" className="loader__sand-line-right"
                            ></line>
                        ...
                        <g strokeWidth="2" strokeLinecap="round" opacity="0.7" fill="none">
                            ...
                            ></path>
                            <path
                                transform="rotate(180,12.25,16.75)" d="M 19.437 3.421 C 19.437 3.421 19.671 6.454 17.914 8.846 C 16.157 11.238 14.5 11.5 14.5 11.5"
                        ...
                        <rect height="2" width="24.5" y="31.5"
                            fill="hsl(var(--hue),90%,50%)"
                        ></rect>
                        <rect
                            height="1" width="19.5" y="32" x="2.5" ry="0.5" rx="0.5" fill="hsl(var(--hue),90%,57.5%)"
                        ></rect>
                    </g>
                </g>
            </svg>
