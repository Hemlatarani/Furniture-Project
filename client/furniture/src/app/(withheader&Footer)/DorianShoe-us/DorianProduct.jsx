...
export default function DorianProduct() {
  return (
    <>
     <section>
                    <div className='max-w-[1270px] mx-auto'>
                        <div className="w-full flex justify-center    mt-[50px]">
                                            {/* Heading */}
                                            <h2 className="text-2xl font-bold text-gray-600">Related Products</h2>
                        ...
                        <div className='grid lg:grid-cols-4  sm:grid-cols-2 md:grid-cols-1 m-10 py-2 gap-5'>
