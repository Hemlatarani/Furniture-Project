...
export default function DorianContent() {
  return (
    <>
    <section>
...
<div className='grid lg:grid-cols-2 sm:grid-cols-1 gap-5 m-5'>
    <div className=' shadow-2xl my-5 '>
        ...
        <div className="flex justify-center gap-5 my-5 ">
            <div className='border'>
                <img src="https://wscubetech.co/Assignments/furniture/storage/app/public/uploads/images/products/1620666061907Gloria%20Shoe%20Racks_.jpg" className="w-[100] " alt="" />
            </div>
           <div className='border'>
                <img src="https://wscubetech.co/Assignments/furniture/storage/app/public/uploads/images/products/1620666061907Gloria%20Shoe%20Racks_.jpg" className="w-[100] " alt="" />
            </div>
    ...
    <div className=' shadow-2xl px-5'>
        <h1 className="font-bold text-3xl py-2">Dorian Shoe Rack</h1>
        <div className="flex gap-3 ">
            <h2 className='line-through gap-4'>Rs.3,400 </h2>
            <span className='font-bold text-[#c09578]'>Rs.2,900</span>
        </div>
